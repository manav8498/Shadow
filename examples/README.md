...
scenario demonstrates, what Shadow catches, and — honestly — what it
doesn't. Smaller scenarios (`demo/`, `edge-cases/`, `acme-extreme/`,
`integrations/`, `judges/`) document themselves in-code via the
generator scripts or — for `judges/` — a `README.md`.
