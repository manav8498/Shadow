...
lint-python:
    ...
    uv run --python .venv/bin/python mypy --config-file python/pyproject.toml --strict python/src examples/demo/agent.py examples/demo/generate_fixtures.py examples/stress_v16x/run_stress.py
...
ci-local:
    ...
    .venv/bin/python -m mypy --config-file python/pyproject.toml --strict python/src examples/demo/agent.py examples/demo/generate_fixtures.py examples/stress_v16x/run_stress.py
